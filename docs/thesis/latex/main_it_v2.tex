...
\emph{mixed-batch}, che alterna uniformemente tutte le difficoltà, per
la guida urbana in CARLA, con sei agenti (tre veicoli e tre pedoni) che
apprendono simultaneamente in un unico mondo condiviso con MAPPO e
critic centralizzato. Una campagna $2\times2$ appaiata per seed incrocia
...
sviluppo guidato da gate e misurata con un criterio di successo
rigoroso, con repliche a seed identico a fornire una banda di rumore
esplicita.
...
\input{chapters_it_v2/ch01_introduzione}

% Blocco II — Il progetto
\input{chapters_it_v2/ch02_piattaforma}
\input{chapters_it_v2/ch03_metodo}
\input{chapters_it_v2/ch04_risultati}

% Blocco III — Possibili evoluzioni
\input{chapters_it_v2/ch05_evoluzioni}

% Blocco IV — Conclusioni
\input{chapters_it_v2/ch06_conclusioni}

% ----------------- Appendici (fuori conteggio) ---------------
\appendix
\input{chapters_it_v2/appendici}
