...
% ------------------------------------------------------------
\section{Mondo condiviso: la copertura parallela dei task}
\label{sec:mondo}
...
% fuori riga: inline la tripla e' una scatola indivisibile da ~200pt che
% sforava il margine destro di 37.9pt.
\[
...
\texttt{safe\_to\_push} $= (\mathit{hazard} < 0.85)$ fa da gate ai
