...
\todo{When the campaign is closed, state the final run matrix in \S 5.2
(run IDs, commit hash, completion status). Current cells: MLP-C
20260622\_171626 (train$+$eval), MLP-B 20260623\_171855 (train$+$eval),
GNN-C 20260630\_181143 (train done, eval pending), GNN-B
20260714\_155209 (training in flight; eval pending).}
